  ...
  return (
    <div className="pub-auctions-page">
      <div className="pub-auctions-header">
        ...
        <AuthTabBar active="auctions" />
      </div>

      <div className="pub-auctions-cta">
      ...
      {live.length > 0 && (
        <section className="pub-auctions-section">
          <h2 className="pub-auctions-section-title"><span className="live-dot" /> Live Now</h2>
      ...
      {upcoming.length > 0 && (
        <section className="pub-auctions-section">
          <h2 className="pub-auctions-section-title">Upcoming</h2>
          <div className="pub-auctions-grid">
      ...
      {past.length > 0 && (
        <section className="pub-auctions-section">
          <h2 className="pub-auctions-section-title">Recently Ended</h2>
          <div className="pub-auctions-grid">
